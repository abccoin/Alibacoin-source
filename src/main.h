...
static const int64 MAX_MONEY = 20000000 * COIN; // maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 2880 / 250; // 1440 blocks found a day. Priority cutoff is 1 SMC day / 250 bytes.
    }
...
/** Alerts are for notifying old versions if they ABCome too obsolete and
