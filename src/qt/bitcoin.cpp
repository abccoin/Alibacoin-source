...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. AlibaCoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement URI support on the Mac.
    ...
    {
        if (boost::algorithm::istarts_with(argv[i], "AlibaCoin:"))
        {
            ...
            try {
                ...
                // don't log the "file not found" exception, ABCause that's normal for
    ...
    app.setOrganizationName("AlibaCoin");
    app.setOrganizationDomain("we-have-no-domain-yet.nex");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("AlibaCoin-qt-testnet");
    else
        app.setApplicationName("AlibaCoin-qt");
